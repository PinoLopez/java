...
public class wikitest14 {
    private static final String URL = "https://en.wikipedia.org/wiki/Verdiales";
    ...
    public static void pruebaTituloDeLaPagina() throws IOException, InterruptedException {
        ...
        verificarCondicion(titulo != null && titulo.equals("Verdiales - Wikipedia"), "Título correcto", titulo);
    }
    ...
    public static void pruebaTextosEspecificos() {
        List<String> textos = List.of("Andalusia", "flamenco", "music");
    ...
    public static void pruebaImagenes() {
        ...
        verificarCondicion(imagenes.size() > 3, "Más de 3 imágenes", imagenes.size());
    }
