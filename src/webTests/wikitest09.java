...
public class wikitest09 {
    public static void main(String[] args) throws IOException, InterruptedException {
        String url = "https://en.wikipedia.org/wiki/Roland_TR-808";
    ...
    public static void pruebaTituloDeLaPagina(String url) throws IOException, InterruptedException {
        String descripcion = "Verificar que el título de la página sea Roland TR-808 - Wikipedia";
        String titulo = obtenerTituloDeLaPagina(url);
        System.out.println(descripcion);
        System.out.print("Resultado: ");
        if (titulo != null && !titulo.isEmpty() && titulo.equals("Roland TR-808 - Wikipedia")) {
            printColor("OK\n", "verde");
    ...
    public static void pruebaTextoEspecifico(String url) {
        String descripcion = "Verificar que la página contenga el texto 'drum machine'";
        String html = obtenerHtml(url);
        System.out.println(descripcion);
        System.out.print("Resultado: ");
        if (html.contains("drum machine")) {
            printColor("OK\n", "verde");
        } else {
            printColor("ERROR\n", "rojo");
        }
