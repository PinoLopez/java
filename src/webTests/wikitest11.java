...
public class wikitest11 {
    private static final String URL = "https://en.wikipedia.org/wiki/Korg";

    public static void main(String[] args) throws IOException, InterruptedException {
        pruebaCodigoDeEstado();
        pruebaTituloDeLaPagina();
        pruebaNumeroDeEnlaces();
        pruebaTextoEspecifico("electronic musical instruments");
        pruebaTextoEspecifico("synthesizers");
        pruebaElementoPorId("firstHeading");
        pruebaCategoria("Japanese");
    }
    ...
    public static void pruebaTituloDeLaPagina() throws IOException, InterruptedException {
        ...
        verificarCondicion(titulo != null && titulo.equals("Korg - Wikipedia"), "Título correcto", titulo);
    }
    ...
    public static void pruebaCategoria(String categoria) {
        String html = obtenerHtml(URL);
        verificarCondicion(html.contains("/wiki/Category:" + categoria), "Contiene categoría '" + categoria + "'", categoria);
    }
