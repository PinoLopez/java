...
public class wikitest13 {
    private static final String URL = "https://en.wikipedia.org/wiki/London_Underground";
    ...
    public static void pruebaTituloDeLaPagina() throws IOException, InterruptedException {
        ...
        verificarCondicion(titulo != null && titulo.equals("London Underground - Wikipedia"), "Título correcto", titulo);
    }
    ...
    public static void pruebaTextosEspecificos() {
        List<String> textos = List.of("tube", "rapid transit system", "London");
