...
public class wikitest12 {
    private static final String URL = "https://en.wikipedia.org/wiki/Nvidia";
    ...
    public static void pruebaTituloDeLaPagina() throws IOException, InterruptedException {
        ...
        verificarCondicion(titulo != null && titulo.equals("Nvidia - Wikipedia"), "Título correcto", titulo);
    }
    ...
    public static void pruebaTextosEspecificos() {
        List<String> textos = List.of("graphics processing units", "artificial intelligence", "GPUs");
